...
public class RunGameView extends JPanel {
    ...
    public static final double AI_TANK_INITIAL_ANGLE = Math.toRadians(225.0);

    public static final double AI_TANK_2_INITIAL_X = 475.0;
    public static final double AI_TANK_2_INITIAL_Y = GameState.TANK_Y_UPPER_BOUND;
    public static final double AI_TANK_2_INITIAL_ANGLE = Math.toRadians(90.0);
